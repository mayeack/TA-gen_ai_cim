...
| `gen_ai_log` | Main operational index used in alerts, dashboards, and saved searches. Contains raw and enriched GenAI events. | `medadvice3:json`, `gen_ai:tfidf:scoring`, `gen_ai:pii:scoring` |
...
|------------|-------------|-------|--------------|
| `gen_ai:tfidf:scoring` | TF-IDF anomaly detection scoring results for prompts and responses | `gen_ai_log` | `savedsearches.conf` - TFIDF Prompt Scoring, TFIDF Response Scoring, TFIDF Combined Scoring searches |
| `gen_ai:pii:scoring` | PII ML detection scoring results from MLTK models | `gen_ai_log` | `savedsearches.conf` - PII ML Scoring search |
...
|--------|-------------|------------|
| `tfidf_prompt_scoring` | TF-IDF anomaly scoring for prompts | `gen_ai:tfidf:scoring` |
| `tfidf_response_scoring` | TF-IDF anomaly scoring for responses | `gen_ai:tfidf:scoring` |
| `tfidf_combined_scoring` | Combined TF-IDF anomaly scoring | `gen_ai:tfidf:scoring` |
| `pii_ml_scoring` | PII ML detection scoring | `gen_ai:pii:scoring` |
