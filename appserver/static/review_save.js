...
require([
    ...
    function applyDetectionVisibility(type, enabled) {
        ...
        var inputIdMap = {
            'pii': ['input_pii_confirmed', 'pii_types_detected_display', 'input_pii_reviewed', 'input_pii_types_reviewed'],
        ...
        var labelMap = {
            'pii': ['PII Present (Detected)', 'PII Types (Detected)', 'PII Present (Reviewed)', 'PII Types (Reviewed)'],
    ...
    function saveReviewFindings() {
        ...
        var record = {
            ...
            "gen_ai_review_pii_reviewed": getToken("input_pii_reviewed") || "n/a",
