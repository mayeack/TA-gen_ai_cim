...
- `$SPLUNK_HOME/etc/apps/<app>/default/data/ui/views/ml_<detection>_detection.xml` — dashboard build (Phase 6) handles this; if a `local/data/ui/views` copy exists, leave `default/` untouched.
